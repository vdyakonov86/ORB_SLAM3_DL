...
if [[ "$MANAGER" == "apt" ]]; then
    ...
    # PKGS_RECOMMENDED+=(libjpeg-dev libpng-dev catch2) # E: Unable to locate package catch2
    PKGS_RECOMMENDED+=(libjpeg-dev libpng-dev) # E: Unable to locate package catch2
